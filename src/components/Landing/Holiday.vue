...
<template>
  <section class="py-4 md:py-16 text-textheader">
    <div class="mx-auto px-4 w-11.5/12 md:w-10/12">
      <h2 class="text-start text-3xl font-bold font-poppins mb-4">
        Our Holiday Packages <span>🤗</span>
      </h2>
      <p class="text-start text-textheader font-poppins mb-8 w-[712px]">
        ...
        >
          <swiper-slide
            ...
            :key="Holiday.id"
            class="bg-white min-w-[160px] md:min-w-[250px] rounded-md hover:shadow-lg transition-shadow"
          >
            <img
              :src="Holiday.src"
              :alt="Holiday.title"
