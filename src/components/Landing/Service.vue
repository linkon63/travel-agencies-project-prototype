...
<template>
  <section
    class="py-10 flex items-center justify-center mx-auto bg-offerbg text-textpera bg-opacity-40 mt-16 font-poppins"
  >
    <div class="grid md:grid-cols-2 w-11/12 sm:w-10/12 container px-5 mx-auto gap-x-10">
        ...
        <div class="space-y-6">
          ...
          <div class="flex space-x-4 items-start">
            <img
              ...
              alt="Best Travel Pack"
            />
            <div>
              <h3 class="text-xl font-semibold">Best Travel Pack</h3>
              <p class="">Great Opportunityies to travel to enjoy yourself</p>
            </div>
          </div>
          <!-- Feature 2 -->
          <div class="flex space-x-4 items-start">
            <img
              ...
              alt="Airline Best Flights"
            />
            <div>
              <h3 class="text-xl font-semibold">Airline Best Flights</h3>
              <p class="">Great Opportunityies to travel to enjoy yourself</p>
            </div>
          </div>
          <!-- Feature 3 -->
          <div class="flex space-x-4 items-start mb-4">
            <img
              class="w-12 h-12 object-contain"
              src="../../assets/Images/EarthMap.png"
              alt="East Booking"
            />
            <div>
              <h3 class="text-xl font-semibold">East Booking</h3>
              <p class="">Great Opportunityies to travel to enjoy yourself</p>
            </div>
          </div>
          <div>
            <router-link
              to="/umrah-packages-details"
              class="bg-highblue text-white py-2 px-6 rounded-md shadow-md hover:bg-highblue-600"
            >
      ...
      <div class="relative mt-5 grid justify-center items-center h-[366px]">
        <!-- Main Image -->
        <div class="relative">
          <img class="w-80 lg:w-96" src="../../assets/Images/Service.png" alt="Service Image" />
        </div>
      </div>
    </div>
  </section>
