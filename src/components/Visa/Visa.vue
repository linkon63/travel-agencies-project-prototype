              ...
              <div class="border">
                ...
                <div class="gird px-4 py-8 space-y-5 text-textheader">
                  ...
                  <div class="flex justify-center items-center">
                    <button
                      class="border border-highblue text-highblue rounded-md px-12 py-2 font-bold"
                    >
                      Search
                    </button>
                  </div>
          ...
          <div class="col-span-3">
            <div class="gird space-y-7">
              ...
              <div
                ...
                :key="state"
                class="grid grid-cols-3 p-4 bg-graybg rounded-lg place-items-start lg:gap-x-8"
              >
                <div class="">
                ...
                <div class="col-span-2 space-y-1">
                  ...
                  <ul
                    ...
                    :key="list"
                    class="list-disc ps-4 text-textheader text-subtitle"
                  >
                    <li>{{ list }}</li>
                  </ul>

                  <p class="text-textheader text-subtitle font-bold">
                    <i class="pi pi-star-fill text-yellow-300 lg:text-[20px]"></i> 5 (120 Reviews)
                  </p>

                  <button
                    class="text-[13px] md:text-[16px] md:px-3 lg:px-4 lg:py-2 md:rounded-md border border-highblue text-highblue"
                  >
