...
<template>
  <div class="flex justify-between items-center w-full relative bg-white boxShadow px-4 py-3">
    ...
    <div class="flex items-center justify-between lg:justify-around px-4 py-3 w-full">
      ...
      <!-- Navbar Links -->
      <ul class="items-center gap-5 text-[16px] font-normal text-textheader lg:flex hidden">
        <li>
          <router-link
            to="/"
    ...
    >
      <ul class="flex flex-col items-center gap-4 text-lg font-semibold text-gray-600">
        <li>
          <router-link
            to="/"
            class="hover:border-b-blue border-b-[2px] border-transparent transition-all duration-500 cursor-pointer capitalize"
          >
            Home
          </router-link>
        </li>
